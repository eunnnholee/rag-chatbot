EXTRACTION_PROMPT = """You are an expert on the Gender Equality Act.  
...
REWRITE_PROMPT = """You are an expert on the Gender Equality Act.  
        ...
        3. Use appropriate legal terms related to the Gender Equality Act.
...
ANSWER_PROMPT = """You are an expert on the Gender Equality Employment Act.  
        ...
        2. Cites specific articles and provisions from the Gender Equality Employment Act
