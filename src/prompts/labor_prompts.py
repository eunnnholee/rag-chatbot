EXTRACTION_PROMPT = """You are an expert on the LABOR Standards Act.  
...
REWRITE_PROMPT = """You are an expert on the LABOR Standards Act.  
        ...
        3. Use appropriate legal terms related to the LABOR Act.
...
ANSWER_PROMPT = """You are an expert on the Labor Standards Act.  
        ...
        2. Cites specific articles and provisions from the Labor Standards Act
